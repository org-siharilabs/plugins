---
name: agent-builder-node
description: Individual workflow step card in the agent builder canvas, color-coded by type with drag handle and connection ports
